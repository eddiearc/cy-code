<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="学号" prop="id" sortable="custom" align="center" width="150" :class-name="getSortClass('id')">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="专业" prop="major">
          <el-input v-model="temp.major" placeholder="Please enter" />
        </el-form-item>
        <el-form-item label="班级" prop="clazz">
          <el-input v-model="temp.clazz" placeholder="Please enter" />
        </el-form-item>
      </el-form>
